	...
	INSERT INTO public.deparment(
            d_id, name)
    VALUES (2, 'Computer Sciences');

	INSERT INTO public.program(
            p_id, program_name, departmentid)
    VALUES (1, 'MS in Accounting', 1);
	INSERT INTO public.program(
            p_id, program_name, departmentid)
    VALUES (2, 'MS in Computer Sciencs', 2);
	
	
	INSERT INTO public.student_info(
            s_id, cin, dob, email, f_name, gender, l_name, phone, citizenship, 
            user_info_id)
    VALUES (1, null, '10/29/1991', 'student1@localhost.localdomain', 'Hiren', 'M', 'PATEL', '224-247-9207', 'Indian', 
            2);
	
	
	INSERT INTO public.application_details(
            a_id, term, program_id, student_id)
    VALUES (1, 'fall 2016', 1, 1);

	
	INSERT INTO public.additional_info(
            ad_id, file, required, text, application_a_id, department_d_id)
    VALUES (1, null, true, 'GMAT', 1, 1);

	INSERT INTO public.applicationstatus(
            as_id, comment, u_date, application_id, student_id)
    VALUES (1, 'Submited', 'now' , 1 , 1);
	...
	INSERT INTO public.education_background(
            e_id, gpa, gre, tofel, transcript, student_info_s_id)
    VALUES (1, '3.9', 314 , 107 , 'path', 1);
		
	INSERT INTO public.degree_type(
            de_id, degree_type, e_date, major, name, s_date, student_id)
    VALUES (1, 'MS in Accounting', '10/21/2013', 'Accounting', 'UCET', '10/21/2009', 1);
